                ...
                <div className="col-xl-12">
                  <div className="invoice_msg mb-40">
                    <p className="text-black alert alert-success">
                      Thank you <strong>{name}</strong> Your order has been
                      received!
                    </p>
                  </div>
                </div>
              ...
              <div className="invoice__order-table pt-30 pb-30 pl-40 pr-40 bg-white mb-30">
                <table className="table">
                  ...
                  <tbody className="table-group-divider">
                    {cart.map((item, i) => {
                      const variantPrice = item.selectedVariant
                        ? item.selectedVariant.finalPrice
                        : item.price;
                      const discountedPrice =
                        item.discount > 0
                          ? variantPrice - (variantPrice * item.discount) / 100
                          : variantPrice;
                      const itemTotal = discountedPrice * item.orderQuantity;
